...
from .modeling_bart_student import (
    BartModel,
    beam_search_pointer,
    BartForOrdering_student,
)
...
MODEL_FOR_SENTENCE_ORDERING_MAPPING = OrderedDict(
    [
        # (DistilBertConfig, DistilBertForSequenceClassification),
        # (AlbertConfig, AlbertForSequenceClassification),
        # (CamembertConfig, CamembertForSequenceClassification),
        # (XLMRobertaConfig, XLMRobertaForSequenceClassification),
        (BartConfig, BartForOrdering),
        # (LongformerConfig, LongformerForSequenceClassification),
        # (RobertaConfig, RobertaForSequenceClassification),
        # (BertConfig, BertForSequenceClassification),
        # (XLNetConfig, XLNetForSequenceClassification),
...
MODEL_FOR_SENTENCE_ORDERING_MAPPING_STUDENT = OrderedDict(
    [
        # (DistilBertConfig, DistilBertForSequenceClassification),
        # (AlbertConfig, AlbertForSequenceClassification),
        # (CamembertConfig, CamembertForSequenceClassification),
        # (XLMRobertaConfig, XLMRobertaForSequenceClassification),
        (BartConfig, BartForOrdering_student),
        # (LongformerConfig, LongformerForSequenceClassification),
        # (RobertaConfig, RobertaForSequenceClassification),
        # (BertConfig, BertForSequenceClassification),
        # (XLNetConfig, XLNetForSequenceClassification),
...
class AutoModelForsentenceordering:
    r"""
        :class:`~transformers.AutoModelForSequenceClassification` is a generic model class
        that will be instantiated as one of the sequence classification model classes of the library
        when created with the `AutoModelForSequenceClassification.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForSequenceClassification.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_SENTENCE_ORDERING_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        raise ValueError(
            "Unrecognized configuration class {} for this kind of AutoModel: {}.\n"
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_SENTENCE_ORDERING_MAPPING.keys()),
            )
        )
...
class AutoModelForsentenceordering_student:
    r"""
        :class:`~transformers.AutoModelForSequenceClassification` is a generic model class
        that will be instantiated as one of the sequence classification model classes of the library
        when created with the `AutoModelForSequenceClassification.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForSequenceClassification.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_SENTENCE_ORDERING_MAPPING_STUDENT.items():
            if isinstance(config, config_class):
                return model_class(config)
        raise ValueError(
            "Unrecognized configuration class {} for this kind of AutoModel: {}.\n"
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_SENTENCE_ORDERING_MAPPING_STUDENT.keys()),
            )
        )
